...
Route::middleware(['auth', 'XSS'])->group(function () {
    ...
    Route::get('bg/pg', [BGPGController::class, 'index'])->name('bgpg.index');
    Route::get('create/bg/pg', [BGPGController::class, 'create'])->name('bgpg.create');
    Route::post('store/bg/pg', [BGPGController::class, 'store'])->name('bgpg.store');
    Route::get('edit/bg/pg/{id}',[BGPGController::class,'edit'])->name('edit.bg.pg');
    Route::post('update/bg/pg/{id}',[BGPGController::class,'update'])->name('update.bg.pg');
    Route::delete('delete/bg/pg/{id}',[BGPGController::class,'destroy'])->name('delete.bg.pg');

    Route::get('import/bg/pg', [BGPGController::class, 'importFile'])->name('import.bg.ph');
    Route::post('upload/bg/ph', [BGPGController::class, 'import'])->name('upload.bg.ph');
    //Route::get('/reload-table', [BGPGController::class, 'reloadTable'])->name('bgpg.index');
    Route::get('/bgpg/data', [BgPgController::class, 'getData'])->name('bgpg.data');

    //Route::get('export/employee', [EmployeeController::class, 'export'])->name('employee.export');
    Route::post('/delete-multiple-bg-pg', [BGPGController::class, 'deleteMultiple'])->name('delete.multiple.bg.pg');
});
