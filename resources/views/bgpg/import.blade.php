...
{{ Form::open(['route' => ['upload.bg.ph'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'class'=>'uploadModal', 'id' => 'uploadForm']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="choose-files mt-3">
            <label for="file">
                <div class="bg-primary"> <i class="ti ti-upload px-1"></i>{{ __('Select CSV File') }}</div>
...
<script>
    $(document).ready(function() {
        ...
        function reloadTable() {
            $.ajax({
                url: '{{ route("bgpg.index") }}', // Use the table route name
                type: 'GET',
                success: function(response) {
