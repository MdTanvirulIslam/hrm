    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            ...
            <!-- employee-->
                ...
                <!-- bg/pg-->
                <li class="dash-item <?php echo e(Request::segment(1) == 'bg/pg' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('bgpg.index')); ?>" class="dash-link"><span
                            class="dash-micon"><i class="ti ti-user"></i></span><span
                            class="dash-mtext"><?php echo e(__('BG/PG')); ?></span></a>
                </li>
            <!-- bg/pg-->

                <!-- INVOICE MANAGEMENT - NEW SECTION -->
