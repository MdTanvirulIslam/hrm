    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <?php echo e(Form::datetimeLocal('start_date', null, ['class' => 'form-control datetime-local ', 'autocomplete'=>'off'])); ?>
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <?php echo e(Form::datetimeLocal('end_date', null, ['class' => 'form-control datetime-local ','autocomplete'=>'off' ])); ?>
...
<?php /**PATH E:\server\htdocs\hrm_two\resources\views/event/create.blade.php ENDPATH**/ ?>