            ...
            <div class="form-group">
                ...
                <div class="choose-files ">
                    <label for="document">
                        ...
                        <input style="margin-top: -50px" type="file" class="form-control file" name="documents" accept=".doc,.docx,.jpg,.jpeg,.png,.xls,.xlsx,.csv,.pdf"  onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
...
<?php /**PATH D:\xampp\htdocs\hrm\resources\views/documentUpload/create.blade.php ENDPATH**/ ?>